...
When the 'application/cose-c509+cbor' media type is used, the data is a COSE_C509 containing exactly one C509CertData entry. When the 'application/cose-c509+cbor; usage=chain' media type is used, the data is a COSE_C509 containing at least two C509CertData entries that form an ordered chain of C509 certificates.

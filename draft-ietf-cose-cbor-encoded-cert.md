...
In natively signed C509 certificates, bytes as tag 48 does not correspond to any predefined text string encoding and may also be used for attribute types such as macAddress.

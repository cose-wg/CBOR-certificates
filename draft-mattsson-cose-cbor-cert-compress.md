...
* A non-critical keyUsage with only keyAgreement asserted is encoded as the two CBOR ints 2, . 
...
Thus, the extension field of a certificate containing all of the above extensions in the given order would be encoded as the CBOR array \[ -1, -1, 2, ?, 3, \[ 3, 6 \], 4, "example.com" \].

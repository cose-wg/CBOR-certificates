...
Point compressed public keys of type id-ecPublicKey are encoded with the octet (2^8 - Y) instead of Y, i.e. an even y-coodinate is encoded with 0xfe and an odd y-coodinate is encoded with 0xfd.
